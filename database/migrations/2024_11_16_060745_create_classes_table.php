...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('classes', function (Blueprint $table) {
            ...
            $table->string('cls_letter');
            //homeroon buat foreignkey dirrubah string menjadi unsignedBigInteger
            $table->string('cls_homeroom')->nullable();
            $table->timestamps();
            ...
            // $table->foreign('cls_homeroom')->references('usr_id')->on('users')->onDelete('cascade');
        });
    }
