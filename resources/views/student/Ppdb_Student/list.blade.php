          ...
          <form action="{{ route('student.Ppdb_Student.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-9">
                  <select class ="form-select mr-sm-2" value="{{ $student->std_gender }}" id="inLineFormCustomSelect" name="std_gender" oninvalid="this.setCustomValidity ('Jenis Kelamin Wajib Diisi')"
              ...
              <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-9">
                  <input type="text" name="std_birth_place" class="form-control" value="{{ $student->std_birth_place }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Tempat Lahir Kelas Wajib Diisi')" 
                  onchange="this.setCustomValidity('')">
                </div>
              ...
              <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="std_birth_date" class="form-control" value="{{ $student->std_birth_date }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Tanggal Lahir Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="std_child_to" class="form-control" value="{{ $student->std_child_to }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Anak Ke Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                  @error('std_child_to')
                    <div>error</div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="std_number_of_siblings" class="form-control"  value="{{ $student->std_number_of_siblings }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Jumlah Saudara Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="std_address" class="form-control" value="{{ $student->std_address }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Alamat Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                  @error('std_address')
                    <div>error</div>
                  ...
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="std_school" class="form-control" value="{{ $student->std_school }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Nama Sekolah Umum Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('std_school')
                      <div>error</div>
                  ...
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <select name="std_formal_level" id="formalLevel" class="form-control" value="{{ $student->std_formal_level }}" required 
                  ...
                  <div class="mb-4 row align-items-center" id="formalGradeWrapper">
                    ...
                    <div class="col-sm-9">
                      <select name="std_formal_grade" id="formalGrade" class="form-control" value="{{ $student->std_formal_grade }}">
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="number" name="std_nisn" class="form-control" value="{{ $student->std_nisn }}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('NISN Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                  @error('std_nisn')
                    <div>error</div>
