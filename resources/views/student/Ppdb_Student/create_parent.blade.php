                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="mb-4 row align-items-center">
                      ...
                      <div class="col-sm-9">
                        <select class ="form-select mr-sm-2" id="inLineFormCustomSelect" name="ptr_job_mother" oninvalid="this.setCustomValidity ('Pekerjaan Ibu Wajib Diisi')"
                        onchange="this.setCustomValidity('')" required>
                            <option selected value="">Pilih...</option>
                            <option value="PNS">PNS</option>
                            <option value="Pegawai Swasta">Pegawai Swasta</option>
                    ...
                    <div class="mb-4 row align-items-center">
                      ...
                      <div class="col-sm-9">
                        <select class ="form-select mr-sm-2" id="inLineFormCustomSelect" name="ptr_income_mother" oninvalid="this.setCustomValidity ('Penghasilan Ibu Wajib Diisi')"
                        onchange="this.setCustomValidity('')" required>
                            <option selected value="">Pilih...</option>
                            <option value="0">0</option>
                            <option value="<1.000.000">< 1.000.000 </option>
