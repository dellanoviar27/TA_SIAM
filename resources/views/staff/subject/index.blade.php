...
@section('title')
    SIAM Al-Mu'min | Daftar Mata Pelajaran
@endsection
                    ...
                    <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$Subject->semester->smt_semester}}</td>
                                <td>
                                     <a href="/staff/subject/{{$Subject->sbj_id}}/edit" class="btn btn-primary">Edit</a>
                                     <a href="/staff/subject/{{$Subject->sbj_id}}/destroy" class="btn btn-danger" data-confirm-delete="true">Delete</a>
