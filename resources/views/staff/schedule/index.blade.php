                ...
                <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/staff/schedule/{{ $Schedule->sch_id }}/edit" class="btn btn-sm btn-primary">Edit</a>
                                <a href="/staff/schedule/{{ $Schedule->sch_id }}/destroy" class="btn btn-sm btn-danger" data-confirm-delete="true">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
