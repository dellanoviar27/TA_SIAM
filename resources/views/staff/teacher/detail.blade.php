        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="d-flex align-items-center gap-2 mb-2">
              ...
              <h4>Jenis Kelamin</h4>
              <h6 class="mb-0 fs-4">{{$teacher->tch_gender}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
              ...
              <h6 class="mb-0 fs-4">{{$teacher->tch_last_education}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
              ...
              <h6 class="mb-0 fs-4">{{$teacher->tch_current_education}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
          ...
          <div class="col-lg-6">
            <div class="shop-content">
              ...
              <h4>Tugas Utama</h4>
              <h6 class="mb-0 fs-4">{{$teacher->tch_main_task}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
              ...
              <h6 class="mb-0 fs-4">{{$teacher->tch_additional_task}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>    
            </div>
