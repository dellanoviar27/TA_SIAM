...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
      <div class="row align-items-center">
        <div class="col-9">
          <h4 class="fw-semibold mb-8">Detail Staf</h4>
        ...
        <div class="row">
          <div class="col-lg-6">
             ...
             <div class="d-flex align-items-center gap-2 mb-2">
              ...
              <h4>NIK</h4>
              <h6 class="mb-0 fs-4">{{$staff->stf_nik}}</h6>
              ...
              <h4>Jenis Kelamin</h4>
              <h6 class="mb-0 fs-4">{{$staff->stf_gender}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
              ...
              <h4>No. Hp</h4>
              <h6 class="mb-0 fs-4">{{$staff->stf_phone}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
              ...
              <h4>Alamat</h4>
              <h6 class="mb-0 fs-4">{{$staff->stf_address}}</h6>
              <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                <ul class="list-unstyled d-flex align-items-center mb-0">
              </div>
