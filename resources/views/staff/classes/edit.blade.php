          ...
          <form action="" method="post">
            ...
            <div class="card-body">
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cls_general_level" value="{{$Classes->cls_general_level}}" class="form-control" id="exampleInputText1" placeholder="" required oninvalid="this.setCustomValidity('Kelas Umum Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
