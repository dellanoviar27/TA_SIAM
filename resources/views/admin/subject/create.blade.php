          ...
          <form action="" method="post">
            ...
            <div class="card-body">
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="sbj_name_subject" class="form-control" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Mata Pelajaran Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                  @error('sbj_name_subject')
                    <div>error</div>
                  @enderror
                </div>
                ...
                <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="sbj_code" class="form-control" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Kode n Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('sbj_code')
                      <div>error</div>
                  ...
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="sbj_semester" class="form-control" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Semester Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('sbj_semester')
                      <div>error</div>
