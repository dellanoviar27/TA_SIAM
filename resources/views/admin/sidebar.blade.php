          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./main/index3.html" aria-expanded="false">
                ...
                <span class="hide-menu">Kelola Data Guru</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./main/app-calendar.html" aria-expanded="false">
                ...
                <span class="hide-menu">Kelola Data Siswa</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/classes" aria-expanded="false">
                <span>
                  <i class="ti ti-user-circle"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./landingpage/index.html" aria-expanded="false">
                ...
                <span class="hide-menu">Kelola Wali Kelas</span>
              </a>
            </li>
            {{-- <li class="sidebar-item">
              <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
