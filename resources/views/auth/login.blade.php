            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="../main/index.html" class="text-nowrap logo-img text-center d-block mb-5 w-100">
                  <img src="../assets/images/logos/dark-logo2.png" class="dark-logo" alt="Logo-Dark" />
                ...
                @csrf
                  ...
                  <div class="mb-3">
                    ...
                    <input id="email" type="email" class="form-control"  name="email" :value="old('email')" aria-describedby="emailHelp" required autofocus autocomplete="username">
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="form-check">
                      <input id="remember_me" class="form-check-input primary" type="checkbox" name="remember" value="" checked>
                  ...
                  <button class="btn btn-primary w-100 py-8 mb-4 rounded-2" type="submit"> {{ __('Log in') }}</button>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-medium">Belum punya akun?</p>
                    <a class="text-primary fw-medium ms-2" href="/register">Daftar di sini</a>
                  </div>
                </>
              </div>
            </div>
